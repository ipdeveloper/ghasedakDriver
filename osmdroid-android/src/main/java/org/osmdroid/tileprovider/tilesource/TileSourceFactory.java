...
public class TileSourceFactory {
	...
	public static final OnlineTileSourceBase MAPNIK = new XYTileSource("Mapnik",
			5, 17, 256, ".png", new String[] {
					"http://185.252.28.133/hot1/"},"© OpenStreetMap contributors");

	public static final OnlineTileSourceBase PUBLIC_TRANSPORT = new XYTileSource(
			"OSMPublicTransport", 5, 17, 256, ".png",
			new String[] { "http://185.252.28.133/tiles/" },"© OpenStreetMap contributors");
