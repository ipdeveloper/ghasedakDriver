        ...
        if (zoom < 2) {
          ...
          the calculations due to wrap around screw things up because the bounds is more than 1 globe.
            ...
            for (double i = sn_start_point; i <= sn_stop_point; i = i + incrementor) {
                ...
                GeoPoint gx = new GeoPoint(i, east);
                pts.add(gx);
                gx = new GeoPoint(i, west);
                pts.add(gx);
                if (DEBUG) {
                    System.out.println("drawing NS " + i + "," + east + " to " + i + "," + west + ", zoom " + zoom);
                }
            ...
            for (double i = we_startpoint; i <= ws_stoppoint; i = i + incrementor) {
                ...
                p.setColor(lineColor);
                List<GeoPoint> pts = new ArrayList<GeoPoint>();
                GeoPoint gx = new GeoPoint(north, i);
                pts.add(gx);
            ...
            if (dateLineVisible) {
                ...
                for (double i = we_startpoint; i <= 180; i = i + incrementor) {
                    ...
                    if (DEBUG2) {
                        System.out.println("DATELINE drawing NS" + south + "," + i + " to " + north + "," + i + ", zoom " + zoom);
                    }
                ...
                for (double i = -180; i <= ws_stoppoint; i = i + incrementor) {
                    ...
                    if (DEBUG2) {
                        System.out.println("DATELINE drawing EW" + south + "," + i + " to " + north + "," + i + ", zoom " + zoom);
                    }
