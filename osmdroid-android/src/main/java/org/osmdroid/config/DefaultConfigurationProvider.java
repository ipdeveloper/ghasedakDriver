...
public class DefaultConfigurationProvider implements IConfigurationProvider {
    ...
    public void load(Context ctx, SharedPreferences prefs) {
        ...
        if (!prefs.contains("osmdroid.basePath")) {
            ...
            setExpirationExtendedDuration(prefs.getLong("osmdroid.ExpirationExtendedDuration", expirationAdder));
            setMapViewRecyclerFriendly(prefs.getBoolean("osmdroid.mapViewRecycler", mapViewRecycler));
